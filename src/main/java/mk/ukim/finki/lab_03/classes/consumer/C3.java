...
public class C3 {
    public static void main(String[] args) throws Exception {
        ...
        channel.queueBind(queueName, TopicExchange.EXCHANGE_NAME, RouteTypes.R3.getType());
        ...
        DeliverCallback deliverCallback = (consumerTag, delivery) -> {
            // CSV file rows form: 'studentName', 'roomType', 'roomId', 'date'
    ...
    private static String generateRowForCSV(String routeKey) {
        ...
        // Example: AJ, 1, office, Sun Dec 11 21:20:00 CET 2022
